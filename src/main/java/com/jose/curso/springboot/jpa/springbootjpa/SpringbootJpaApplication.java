package com.jose.curso.springboot.jpa.springbootjpa;
...
import com.jose.curso.springboot.jpa.springbootjpa.repositories.PersonRepository;
...
public class SpringbootJpaApplication implements CommandLineRunner {
	...
	public void whereIn() {
		...
		List<Person> persons = repository.getPersonByIds(Arrays.asList(1L, 2L, 6L, 7L));
	...
	public void subQueries() {
		...
		System.out.println("=========================== Consultas para obtener el ultimo registro por id =========================== ");
	...
	public void queriesFunctionAggregation() {
		...
		System.out.println("=========================== Consultas con el valor del id minimo  =========================== ");

		Long min = repository.getMinId();
		System.out.println(min);

		System.out.println("=========================== Consultas con el valor del id maximo  =========================== ");
		...
		System.out.println("=========================== Consultas con el nombre mas corto de la tabla persona  =========================== ");
		Integer minLengthName = repository.getMinLengthName();
		System.out.println(minLengthName);

		System.out.println("=========================== Consultas con el nombre mas largo de la tabla persona  =========================== ");
		Integer maxLengthName = repository.getMaxLengthName();
		System.out.println(maxLengthName);

		System.out.println("=========================== Consultas resumen de funciones agregacion min,max,coun, avg, count  =========================== ");
	...
	public void personalizedQueriesBetween() {
		...
		System.out.println("=========================== Consultas por rangos between  =========================== ");
		List<Person> persons = repository.findByIdBetweenOrderByNameDesc(2L,5L);
		persons.forEach(System.out::println);

		persons = repository.findByNameBetweenOrderByNameDescLastnameAsc("E", "Q");
		persons.forEach(System.out::println);
	...
	public void personalizedQueriesConcatUpperAndLowerCase() {
		System.out.println("=========================== Consultas nombre y apellidos  =========================== ");

		List<String> names = repository.findAllFullNameConcat();
		names.forEach(System.out::println);

		System.out.println("=========================== Consultas nombre y apellido mayusculas  =========================== ");
		names = repository.findAllFullNameConcatUpper();
		names.forEach(System.out::println);

		System.out.println("=========================== Consultas nombre y apellido minusculas  =========================== ");
		names = repository.findAllFullNameConcatLower();
		names.forEach(System.out::println);

		System.out.println("=========================== Consultas personalizada upper y lowercase  =========================== ");
	...
	public void personalizedQueriesDistinct() {
		...
		System.out.println("=========================== Consultas con cuantos Lenguajes de programacion unicos existen =========================== ");
		Long programmingLanguagesCount = repository.findAllProgrammingLanguagesDistinctCount();
	...
	public void personalizedQueries2() {
		...
		System.out.println("Consulta que pobla y devuelve objeto entity de una instancia poersonalizada");
	...
	public void personalizedQueries() {
		...
		System.out.println("====== Consultar por campos personalizados por el id ======");
	...
	public void findOne() {
		...
		// Person person = null;
		// Optional<Person> optionalPerson = repository.findOneName("Emilia");
		...
		// repository.findOneName("Emilia").ifPresent(System.out::println);
